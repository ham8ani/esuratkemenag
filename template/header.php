...
<html lang="en">
    <head>
        ...
        <title>Dashboard - E-Surat Kemenag Kepri </title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">E-Surat Kemenag Kepri </a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="?halaman=surat_masuk">Surat Masuk</a>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="?halaman=disposisi">Tambah Disposisi</a>
                                            <a class = "nav-link" href = "?halaman=pengirim_surat">Tambah Pengirim Surat</a>
                                            <a class = "nav-link" href = "?halaman=user">Tambah User </a>
